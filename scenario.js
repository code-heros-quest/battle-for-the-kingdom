...
let cityChoices = {
  choice1: new Choice('Circus Troupe', 'dialogue', null),
  choice2: new Choice('Minstrals', 'dialogue', null),
  choice3: new Choice('Brotherhood of Monks', 'dialogue', null)
}



let cityAroundThePalace = new Senario('CITY SURROUNDING THE CASTLE', 'dialogue', cityChoices)
