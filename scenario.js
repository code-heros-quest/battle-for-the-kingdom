...
const cityAroundThePalace = new Senario('CITY SURROUNDING THE CASTLE', 'Your band arrives to the city surrounding the palace with plans to meet the contact you were given when you first crossed through the kingdoms walls. However things never go exactly as planned… The kings guards are swarming the city and a group of mighty fighters like yourselves can’t just walk through the city unnoticed. You will have to go in disguised and hope that your contact will be able to recognize you.', 'What kind of disguise do you think you should use?', cityChoices)

// NPC 5 : Rebellion
const rebellion = new Senario();

// BOSS 4 : Hydra
const theHydra = new Senario();

// NPC 4 : Witch
const theWitch = new Senario();

// NPC 3 : Merchant
const theMerchant = new Senario();

// BOSS 3 : Troll
const theTroll = new Senario();

// BOSS 2 : Goblin
const theGoblin = new Senario();

// poisonous bite
const poinsonousBite = new Senario();

// the village
const theVillage = new Senario();

// NPC 1
const theWoodsmanChoices = {
  lowRoll: new Choice(1, 'Poor Roll', `unfortuanatley `, null, theVillage),
...
const theOrcLord = new Senario('Battling the Orc Lord', 'Your team decides the best way through a wall is over the dead body of an Orc so you prepare for battle.', 'roll the dice', theOrcLordChoices)
